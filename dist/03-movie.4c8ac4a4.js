...
})({"96jlw":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "b3000e9b4c8ac4a4";
"use strict";
...
},{}],"93lYq":[function(require,module,exports,__globalThis) {
...
document.addEventListener('DOMContentLoaded', async ()=>{
    ...
    try {
        // Fetch movie details
        const movie = await (0, _apiJs.fetchMovieDetails)(movieId);
        ...
        if (rawDvdDate && rawDvdDate !== 'N/A') {
            ...
            if (!isNaN(dvdDate)) movieDVD.textContent = dvdDate.toLocaleDateString('fr-FR');
            else movieDVD.textContent = 'DVD release date format invalid.';
        } else movieDVD.textContent = 'DVD release date not available.';
    } catch (error) {
...
},{}]},["96jlw","93lYq"], "93lYq", "parcelRequire94c2")

//# sourceMappingURL=03-movie.4c8ac4a4.js.map
