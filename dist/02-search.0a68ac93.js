...
})({"gpyOK":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "73eb82090a68ac93";
"use strict";
...
},{}],"iGqO4":[function(require,module,exports,__globalThis) {
...
document.addEventListener('DOMContentLoaded', ()=>{
    ...
    const searchMovies = async (query, page = 1)=>{
        try {
            const movies = await (0, _apiJs.fetchMovies)(query, page);
            if (movies.length > 0) displayResults(movies);
            else if (page === 1) searchResults.innerHTML = `<p>No movies found for "${query}".</p>`;
        } catch (error) {
    ...
    searchBar.addEventListener('input', async (e)=>{
        ...
        } else if (!query) searchResults.innerHTML = ''; // Effacer les résultats si le champ est vide
    });
...
},{}]},["gpyOK","iGqO4"], "iGqO4", "parcelRequire94c2")

//# sourceMappingURL=02-search.0a68ac93.js.map
